...
|---|---|---|---|
| 1 | Title and machine-readiness start, 0-1 min | První kroky v R a RStudiu | Keep the title visually minimal. While it remains visible, ask everyone to open RStudio. The only checkpoint is that the application window opens; do not ask students to type into an unexplained panel yet. |
